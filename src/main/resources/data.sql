...
INSERT INTO precedent(precedent_id, precedent_title, precedent_category, precedent_number,
                      precedent_subtitle, precedent_overview,
                      precedent_claim, precedent_judgement)
                      VALUES(2, '内助の功はどう扱われる？', '民法', '昭４２（タ）１１号'
                             , '法的な内助の功の取り扱い',
                             '【判例の内容】
                              本判例は「婚姻中の夫婦は一心同体となって活動するものであって、夫婦の一方が得た財産ももう片方の協力があって初めて取得されたものであることから、配偶者はその財産に一種の持ち分的権利を有するものであり、それが財産分与請求権である」として、いわゆる内助の功の存在を認めた。
                              さらに、判例は婚姻関係が破綻し離婚に至った場合、配偶者を支えていた者が路頭に迷うおそれもある。財産分与請求権にはそれを防ぎ、離婚後の扶養の性格をももつとしている。',
                             '',
                             '');
INSERT INTO precedent(precedent_id, precedent_title, precedent_category, precedent_number,
